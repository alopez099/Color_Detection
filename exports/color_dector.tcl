...
#
# color_dector.tcl: Tcl script for re-creating project 'color_dector'
#
# Generated by Vivado on Thu Dec 01 14:54:48 PST 2022
...
#
# 1. This project restoration tcl script (color_dector.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/andy/Documents/ece_520/fa22-ece520-final-project-alopez099/hardware/color_dector/color_dector.srcs/constrs_1/new/master.xdc"
#    "/home/andy/Documents/ece_520/fa22-ece520-final-project-alopez099/hardware/color_dector/color_dector.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../hardware/color_dector/color_dector.srcs/constrs_1/new/master.xdc"]"\
 "[file normalize "$origin_dir/../hardware/color_dector/color_dector.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "color_dector"
...
set script_file "color_dector.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../hardware/color_dector"]"
...
set file "[file normalize "$origin_dir/../hardware/color_dector/color_dector.srcs/constrs_1/new/master.xdc"]"
...
set_property -name "target_constrs_file" -value "[get_files *new/master.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/master.xdc]" -objects $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  set_property CONFIG.PMOD {jd} $PmodCOLOR_0
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../hardware/color_dector/color_dector.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/color_dector.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/color_dector.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/color_dector.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/color_dector.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
